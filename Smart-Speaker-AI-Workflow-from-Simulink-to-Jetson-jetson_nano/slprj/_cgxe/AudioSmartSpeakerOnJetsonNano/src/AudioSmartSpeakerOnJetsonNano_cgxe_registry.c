...
#define S_FUNCTION_NAME                AudioSmartSpeakerOnJetsonNano_cgxe
#include "simstruc.h"
...
static void mdlStart(SimStruct* S)
{
  ...
  success = cgxe_AudioSmartSpeakerOnJetsonNano_method_dispatcher(S,
...
static mxArray* cgxe_get_supported_modules(void)
{
  ...
  checksumData[0] = 1849643150;
  checksumData[1] = 3725739914;
  checksumData[2] = 4273104024;
  checksumData[3] = 1292728756;
  ...
  mxArray* prhs[])
{
...

  {
    ...
    checksumData[0] = 3637578848;
    checksumData[1] = 3278512827;
    checksumData[2] = 972760340;
    checksumData[3] = 1138660108;
...

  {
    ...
    checksumData[0] = 3641229971;
    checksumData[1] = 1262888445;
    checksumData[2] = 988835551;
    checksumData[3] = 633278358;
...

  {
    ...
    checksumData[0] = 3067807939;
    checksumData[1] = 4130238738;
    checksumData[2] = 3654313323;
    checksumData[3] = 1079618916;
  ...
  mxArray * prhs[])
{
  ...
  if (strcmp(tpChksum, "KDwX9EsWGnc16Iuc3hY4E") == 0) {
    extern mxArray *cgxe_KDwX9EsWGnc16Iuc3hY4E_BuildInfoUpdate(void);
    plhs[0] = cgxe_KDwX9EsWGnc16Iuc3hY4E_BuildInfoUpdate();
    return 1;
  }
  ...
  mxArray * prhs[])
{
  ...
  tpChksum[(sizeof(tpChksum)/sizeof(char)-1)] = '\0';
  if (strcmp(tpChksum, "KDwX9EsWGnc16Iuc3hY4E") == 0) {
    extern mxArray *cgxe_KDwX9EsWGnc16Iuc3hY4E_fallback_info(void);
    plhs[0] = cgxe_KDwX9EsWGnc16Iuc3hY4E_fallback_info();
    return 1;
  }
  ...
  int nrhs, const mxArray * prhs[])
{
  ...
  if (ssGetChecksum0(S) == 1849643150 &&
    ...
    extern void cgxe_KDwX9EsWGnc16Iuc3hY4E_get_all_custom_code_global_var_addr
      (void**);
    void** addressArray = (void**)mxGetData(prhs[2]);
    cgxe_KDwX9EsWGnc16Iuc3hY4E_get_all_custom_code_global_var_addr(addressArray);
    return 1;
  }
